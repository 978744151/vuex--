    ...
    <div class="goodlist">
      <div class="cart_list" v-for="(items,index) in goodlist" :key="index">
        <div class="cart_checkbox" v-if="items.morespec == 0">
          ...
          <!-- <input type="checkbox"  v-model="items.checked" @click="changecheck(items)"> -->
        </div>
  ...
  methods: {
    ...
    all_check() {
      if (!this.quanxuan == true) {
        ...
        this.goodlist.forEach((value, index) => {
        // if(value.morespec == 0){
        //     this.jiesuannum = value.goodsnum
        //     this.jiesuanstroage = value.specstorage
        //     if(parseInt(this.jiesuannum) > parseInt(this.jiesuanstroage)){
        //         // console.log('1');
        //     }
        // }else{
        //     this.jiesuannum = value.goodsnum
        //     this.jiesuanstroage = value.storage
        //     if(parseInt(this.jiesuannum) > parseInt(this.jiesuanstroage)){
        //         // console.log('2');
        //     }
        // }          
    ...
    changecheck(items,stroage,num) {
      this.jiesuannum = parseInt(num)
      this.jiesuanstroage = parseInt(stroage)
      // console.log(this.jiesuannum)
      // console.log(this.jiesuanstroage)
      if(parseInt(num) > parseInt(stroage)){
        Toast({
        message: '库存不足',
        position: 'bottom',
